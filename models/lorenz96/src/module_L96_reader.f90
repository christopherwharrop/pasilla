...
!  use Reader, only : reader_type
  ...
  public :: l96_reader_type

  type :: l96_reader_type
      private
...
contains
  ...
  ! constructor
  !
  ! Returns an initialized l96_reader_type object
  !------------------------------------------------------------------
  type(l96_reader_type) function constructor(io_format)
  ...
  ! destructor
  !
  ! Deallocates pointers used by a l96_reader_type object (none currently)
  !------------------------------------------------------------------
  elemental subroutine destructor(this)

    type(l96_reader_type), intent(inout) :: this

    ! No pointers in l96_reader_type object so we do nothing
